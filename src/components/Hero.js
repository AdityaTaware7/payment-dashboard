...
export default function Hero() {
    ...
    const [price, setPrice] = React.useState(179)
                    ...
                    <div className='form-container'>
                        ...
                        <div>
                            ...
                            <div className='form-container-small selected-plan'>
                                <input type="radio" name="12 month1" value="179" checked={price === 179}
                        ...
                        <div className='form-container-small'>
                            <input type="radio" name="12 month1" value="149" checked={price === 179} onChange={handleChange} />
                        ...
                        <div className='form-container-small'>
                            <input type="radio" name="12 month1" value="99" checked={price === 99} onChange={handleChange} />
                        ...
                        <div className='payment-container'>
                            ...
                            <div className='payment-container-inner1' style={{ paddingTop: "0px" }}>
                                ...
                                <p style={{ fontSize: "16px", marginTop: "0px" }} className='section-heading-text-bold'>₹ {price}</p>
                            </div>
