                    ...
                    <div className='form-container'>
                        ...
                        <div>
                            ...
                            <div className='form-container-small selected-plan'>
                                <input type="radio" name="price" value="179"
                        ...
                        <div className='form-container-small'>
                            <input type="radio" name="price" value="149" onChange={handleChange} />
                        ...
                        <div className='form-container-small'>
                            <input type="radio" name="price" value="99" onChange={handleChange} />
